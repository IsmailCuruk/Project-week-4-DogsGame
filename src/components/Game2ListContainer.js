...
class Game2ListContainer extends Component {
    consoleLogMethod() {
...
export default connect(mapStateToProps, { setImages, setRandomDogs, setShuffledRandomDogs, setCorrect, setIncorrect, toggleDisable })(Game2ListContainer)